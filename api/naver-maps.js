...
module.exports = function handler(req, res) {
  ...
  if (!ncpKeyId) {
    res.statusCode = 200;
    res.end('window.__NAVER_MAPS_LOAD_ERROR__ = "NAVER_CLOUD_MAPS_NCP_KEY_ID 환경 변수가 없어 네이버 지도를 불러오지 못했습니다. Vercel Settings > Environment Variables에 첫 번째 캡처의 Naver Cloud Maps Client ID를 추가한 뒤 Redeploy 해주세요.";');
    return;
  }
